...
type Manager interface {
	...
	Start(activePods ActivePodsFunc, sourcesReady config.SourcesReady, initialContainers *containermap.ContainerMapWithLock, initialContainerRunningSet sets.Set[string]) error
